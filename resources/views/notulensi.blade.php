    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="./surat_masuk">Surat Masuk</a>
		...
		<div class="table-wrapper">
			...
			<table class="table table-striped table-hover">
				...
				<tr>
						...
						<td>{{ $data->id}}</td>
						<td>{{ $data->Kode_notulen}}</td>
						<td>{{ $data->Tanggal_rapat}}</td>
						<td>{{ $data->Upload_surat_undangan}}</td>
						<td>{{ $data->Jurusan}}</td>
                        <td>{{ $data->Catatan}}</td>
						...
						<form action=" notulensi/{{$data -> id}}  " method="POST">
...
<div id="addEmployeeModal" class="modal fade">
	<div class="modal-dialog">
		...
		<form action="{{url('notulensi')}}" method="POST">
				@csrf


				<div class="modal-header">						
					<h4 class="modal-title">Tambahkan Notulen</h4>
